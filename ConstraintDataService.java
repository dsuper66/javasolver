      ...
      for (ConstraintDef constraintDef : constraintDefs) {
         ...
         for (ModelElement parentElement
            ...
            if (!constraintDef.varType.equals("")) {
               ...
               String varId = addVar(parentElement.elementId, constraintDef.varType);
                     ...
                     for (ModelElement childMatchingType : modelDataService.getElements(cc.elementType)) {
                        if ((
                           ...
                           if (parentElement.elementType.equals("bus") && cc.propertyMap.equals("fromBus")){
                              fromBusMap.putIfAbsent(childMatchingType.elementId,parentElement.elementId);
                           }
                           else if (parentElement.elementType.equals("bus") && cc.propertyMap.equals("toBus")){
                              toBusMap.putIfAbsent(childMatchingType.elementId,parentElement.elementId);
                           }
                           ...
                           String varId = addVar(childMatchingType.elementId, cc.varType);
